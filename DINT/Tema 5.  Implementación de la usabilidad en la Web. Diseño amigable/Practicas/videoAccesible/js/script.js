...
var buttonEnglish, buttonDeutsch, buttonEspanol;

window.onload = function () {
    console.log("init");
    // when the page is loaded
    video = document.querySelector("#mVideo");
    ...
    buttonEspanol = document.querySelector("#buttonEspanol");
...
function displayCues(track) {
    ...
    for (var i = 0, len = cues.length; i < len; i++) {
        ...
        var clickableTransText = "<li class='cues' id=" + cue.id + " onclick='jumpTo(" + cue.startTime + ");'" + ">" +
            transText + "</li>";
